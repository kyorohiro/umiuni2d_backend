...
class NetBoxFileShareManager {
  ...
  Future<Map<String, String>> fileShare(String src, String articleId, String loginId) async {
    ...
    TinyNetRequesterResponse response = await requester.request(TinyNetRequester.TYPE_POST, url, //
      ...
      data: conv.JSON.encode(//
        {NetBox.ReqPropertyLoginId: loginId, NetBox.ReqPropertyArticleId: articleId, NetBox.ReqPropertyRequestID: "AABBCC"}));
    ...
    //
    {
      ...
      return await conv.JSON.decode(conv.UTF8.decode(response.response.asUint8List()));
    }
  }
}
